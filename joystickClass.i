# 1 "hal/joystick/joystickClass.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 4 "hal/joystick/joystickClass.cpp" 2


JoystickClass::JoystickClass()
{
 fd = open ("/dev/input/js0", 00);
 ioctl (fd, (((2U) << (((0 +8)+8)+14)) | ((('j')) << (0 +8)) | (((0x11)) << 0) | ((((sizeof(__u8)))) << ((0 +8)+8))), &number_of_axes);
